    ...
    const entries = [
      {
        ...
        answer: (
          <p>
            Telehelp bidrar endast med att knyta samman volontärer och de som
            behöver hjälp. Det är upp till er att gemensamt hitta en lösning som
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            bör inte äldre besöka matvarubutiker om de kan undvika detta, för
            att minimera antalet hårt drabbade av viruset. Telehelp bidrar med
            en tjänst som minimerar riskgruppers risk att bli utsatta av
            viruset.
          </p>
        ),
      },
      {
        question: "Kan jag hjälpa mer än en person?",
        answer: (
          <p>
            För att minimera smittorisken och förenkla användarupplevelsen är
            tjänsten byggd för att du ska kunna paras ihop med en person i
            taget. Personen kan när som helst välja att byta till en annan
            volontär, vartefter ni inte längre kan komma i kontakt. Även du
            själv kan ta bort ditt konto om du inte längre vill använda
            tjänsten, men vi rekommenderar att du förklarar detta för den du
            hjälper först.
          </p>
        ),
      },
      {
        ...
        answer: (
          <p>
            ...
            en person rekommenderar vi att du förklarar varför du inte längre
